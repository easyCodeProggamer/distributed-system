package com.youtube.contentConsumer.prime.primeConsumer.configuration;
...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerFactory<String,ContentMetaData> consumerFactory(){
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES,"com.youtube.contentConsumer.prime.primeConsumer.model");
